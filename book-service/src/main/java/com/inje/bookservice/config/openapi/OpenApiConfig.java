package com.inje.bookservice.config.openapi;

import com.inje.bookservice.config.openapi.annotation.ApiErrorResponse;
import com.inje.bookservice.config.openapi.annotation.ApiErrorResponses;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        Info info = new Info()
                ...
                .description("MSA Demo Application - Book Service API");
