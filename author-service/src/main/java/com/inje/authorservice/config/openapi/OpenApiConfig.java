package com.inje.authorservice.config.openapi;

import com.inje.authorservice.config.openapi.annotation.ApiErrorResponse;
import com.inje.authorservice.config.openapi.annotation.ApiErrorResponses;
...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        Info info = new Info()
                ...
                .description("MSA Demo Application - Author Service API");
